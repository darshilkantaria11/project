           ...
           <style jsx>
            ...
            <div className="flex flex-row flex-wrap justify-between sticky top-0 p-2" style={{ backgroundColor: theme.theme2, color: theme.headingc }}>
                <div className="flex flex-row flex-initial flex-wrap items-center justify-center  ">
                    ...
                    <div className="ho p-2 rounded-md">
                ...
                <div className="flex flex-row flex-initial flex-wrap items-center justify-center   mx-2">
                    <div className="hidden mx-6 flex-none items-center lg:block ho p-2 rounded-md">
                    ...
                    <div className="ho p-2 rounded-md">
                        ...
                        {isOpen && (
                            <div className="absolute top-20 flex-col right-5  p-4 rounded-2xl" style={{ backgroundColor: theme.theme2 }}>
